    ...
    <main>
      ...
      <div className="ImagenLogo">
        <ul>    
            ...
            <img src="http://cine.ar/img/tv.cine.ar.svg" alt="Logo Cine AR TV" />
          
            <img src="http://cine.ar/img/play.cine.ar.svg" alt="Logo Cine AR Play" />
          
            <img src="http://cine.ar/img/estrenos.cine.ar.svg" alt="Logo Cine AR Estrenos" />
